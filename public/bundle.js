...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherForecast = __webpack_require__(220);
	...
	var Weather = React.createClass({
	  ...
	  handleNewAddress: function handleNewAddress(msg) {
	    this.setState({
	      msg: msg
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(WeatherForm, { onNewAddress: this.handleNewAddress }),
	      React.createElement(WeatherForecast, { msg: msg })
	    );
	  }
	});
	...
	var WeatherForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', ref: 'address', placeholder: 'Enter a city name' }),
	      React.createElement(
	        'button',
	        { type: 'submit' },
	        'Get Weather'
